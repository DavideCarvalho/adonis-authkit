...
`@dudousxd/adonis-authkit-react` exports three layers: auth-state primitives, a typed HTTP
...
```tsx
import { usePasswordStrength, PasswordStrengthMeter } from '@dudousxd/adonis-authkit-react'
