...
export async function configure(command: Configure) {
  ...
  await codemods.updateRcFile((rc) => rc.addProvider('@adonis-agora/authkit-client/authkit_client_provider'))
  await codemods.registerMiddleware('router', [{ path: '@adonis-agora/authkit-client/authkit_middleware' }])
