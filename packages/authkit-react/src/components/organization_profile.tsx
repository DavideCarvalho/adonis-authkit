...
function OrganizationProfileInner({
  ...
  if (loading) return createElement('div', { className: 'authkit-org-profile__loading' }, 'Carregando…')
      ...
      : org.members.map((m) =>
          createElement(
            ...
            createElement(
              ...
              createElement('span', { className: 'authkit-org-profile__member-email' }, m.email ?? m.accountId),
