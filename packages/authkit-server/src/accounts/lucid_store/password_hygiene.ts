...
import type { PasswordExpirationCapability, PasswordHistoryCapability } from '../account_store.js';
 ...
 */
export function buildPasswordHistory(ctx: LucidStoreContext, db: any): PasswordHistoryCapability {
  /**
