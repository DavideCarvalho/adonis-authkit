...
export const DEFAULT_MESSAGES = {
  ...
  "consent.body":
    "The app <strong>{app}</strong> wants to access your account.",
  ...
  "account.security.email_change_disabled":
  ...
  "account.profile.not_supported":
    "Profile editing is not available in this installation.",
  ...
  "account.export.requested":
    "Your data export is being prepared and will be delivered shortly.",
  ...
  "account.delete.invalid_confirmation":
    "Confirmation failed. Your account was not deleted.",
  "account.delete.not_supported":
    "Account deletion is not available in this installation.",
  ...
  "account.orgs.not_supported":
    "Organizations are not available in this installation.",
  ...
  "account.email_confirmed.ok_body":
    "Your new email has been confirmed and is now active.",
  ...
  "admin.users.create_password_placeholder":
    "Password (leave blank to send invite)",
  ...
  "admin.users.delete_unsupported":
    "The account store does not support deleting users.",
  ...
  "admin.sessions.grant_tokens":
    "{accessTokens} access · {refreshTokens} refresh",
  ...
  "admin.clients.field_client_id_placeholder":
  ...
  "admin.clients.field_backchannel_session_required":
    "Require sid in logout_token",
  ...
  "admin.audit.not_supported":
    "The configured audit sink does not support querying.",
  ...
  "admin.settings.reset_done":
    "Runtime setting cleared — config is now the source of truth.",
  ...
  "admin.settings.require_verified_email_from_setting":
  ...
  "admin.settings.auth_methods_magic_link_label":
    "Magic link (email login link)",
  ...
  "admin.settings.auth_methods_no_social":
    "No social providers configured in the static config.",
  ...
  "login.email_grace_banner":
    "Please verify your email. You have {days} day(s) remaining.",
  ...
  "mail.security_notice.intro":
    "A security event occurred on your account: {kind}.",
  ...
  "mail.security_notice.kind_mfa_disabled":
  ...
  "admin.settings.otp_lockout_max_attempts_label":
  ...
  "admin.settings.email_change_require_password_label":
  ...
  "admin.settings.security_notifications_from_setting":
    "Source: runtime setting",
  "admin.settings.security_notifications_kind_password_changed":
    "Password changed",
  ...
  "admin.settings.security_notifications_kind_passkey_removed":
    "Passkey removed",
  ...
  "admin.settings.session_policy_remember_enabled_label":
    'Show "Keep me signed in" checkbox',
  "admin.settings.session_policy_remember_days_label":
  ...
  "admin.settings.session_policy_default_hours_label":
  ...
  "admin.settings.session_policy_single_session_label":
  ...
  "admin.settings.lockout_base_lockout_sec_label":
    "Base lockout duration (seconds)",
  "admin.settings.lockout_max_lockout_sec_label":
  ...
  "admin.settings.rate_limit_login_points_label":
    "Login bucket: requests allowed",
  "admin.settings.rate_limit_login_duration_label":
    'Login bucket: window duration (e.g. "1 min")',
  "admin.settings.rate_limit_introspection_points_label":
    "Introspection bucket: requests allowed",
  "admin.settings.rate_limit_introspection_duration_label":
    "Introspection bucket: window duration",
  ...
  "admin.settings.password_policy_from_config":
    "Source: static config / defaults",
  ...
  "admin.settings.password_policy_require_uppercase_label":
    "Require uppercase letter",
  "admin.settings.password_policy_require_lowercase_label":
  ...
  "admin.settings.notifications_from_config":
    "Source: static config / defaults",
  "admin.settings.notifications_from_setting": "Source: runtime setting",
  "admin.settings.notifications_new_login_label":
    "Send new login alert (new IP)",
  "admin.settings.notifications_new_device_label":
  ...
  "admin.settings.trusted_devices_from_config":
    "Source: static config / defaults",
  ...
  "admin.settings.admin_impersonation_from_config":
    "Source: static config / defaults",
  ...
  "admin.settings.organizations_policy_from_config":
    "Source: static config / defaults",
  ...
  "admin.settings.organizations_policy_invitation_ttl_label":
    "Invitation TTL (hours)",
  ...
  "admin.settings.account_expiration_inactive_days_label":
    "Inactivity threshold (days)",
  "admin.settings.account_expiration_warn_days_label":
    "Warn N days before expiry (0 = off)",
  ...
  "mail.account_expiration_warn.subject":
    "Your account will be deactivated due to inactivity",
...
export const PT_BR_MESSAGES = {
  ...
  "account.security.email_change_disabled":
    "A troca de e-mail está desabilitada no momento.",
  "account.security.email_change_cancelled":
  ...
  "account.security.trusted_devices_revoke":
  ...
  "account.security.sessions_intro":
    "Dispositivos e locais onde sua conta está logada agora.",
  ...
  "account.profile.not_supported":
    "A edição de perfil não está disponível nesta instalação.",
  ...
  "account.delete.invalid_confirmation":
    "Confirmação falhou. Sua conta NÃO foi deletada.",
  "account.delete.not_supported":
    "A deleção de conta não está disponível nesta instalação.",
  ...
  "account.orgs.leave_last_owner":
    "Não é possível sair — você é o único proprietário.",
  ...
  "account.orgs.not_supported":
    "Organizations não está disponível nesta instalação.",
  ...
  "account.email_confirmed.ok_body":
    "Seu novo e-mail foi confirmado e já está ativo.",
  ...
  "mfa.passkey.register_error":
    "Não foi possível registrar a passkey. Tente novamente.",
  ...
  "admin.users.create_password_placeholder":
    "Senha (deixe em branco para enviar convite)",
  ...
  "admin.users.disable_confirm":
    "Desabilitar esta conta? O usuário não conseguirá entrar.",
  ...
  "admin.orgs.not_supported":
    "Organizações não estão disponíveis nesta instalação.",
  ...
  "admin.clients.delete_confirm":
    "Excluir este client? Esta ação não pode ser desfeita.",
  ...
  "admin.settings.maintenance_message_label":
  ...
  "admin.settings.auth_methods_magic_link_label":
    "Magic link (link de login por e-mail)",
  "admin.settings.auth_methods_passkey_label": "Passkey (sem senha)",
  "admin.settings.auth_methods_forgot_password_label":
  ...
  "admin.settings.auth_methods_no_social":
    "Nenhum provider social configurado no config estático.",
  "admin.settings.auth_methods_passkey_autofill_label":
  ...
  "device.success.body":
    "Login realizado com sucesso. Você já pode voltar ao dispositivo.",
  ...
  "errors.bot_protection_failed":
    "A verificação anti-bot falhou. Tente novamente.",
  ...
  // Banner de graça de verificação de e-mail.
  "login.email_grace_banner":
    "Verifique seu e-mail. Você tem {days} dia(s) restante(s).",
  ...
  "admin.settings.password_expiration_from_setting":
    "Fonte: setting em runtime",
  "admin.settings.password_expiration_no_column":
  ...
  "mail.verify.intro":
    "Confirme seu endereço de e-mail para concluir a configuração da conta.",
  ...
  "mail.security_notice.intro":
    "Um evento de segurança ocorreu na sua conta: {kind}.",
  ...
  "mail.security_notice.kind_mfa_enabled":
    "verificação em duas etapas habilitada",
  "mail.security_notice.kind_mfa_disabled":
    "verificação em duas etapas desabilitada",
  ...
  "admin.settings.otp_lockout_unlock_ttl_label":
    "Validade do link de desbloqueio (horas)",
  ...
  "admin.settings.security_notifications_kind_passkey_added":
    "Passkey adicionada",
  "admin.settings.security_notifications_kind_passkey_removed":
    "Passkey removida",
  ...
  "admin.settings.session_policy_remember_enabled_label":
    'Exibir checkbox "Manter conectado"',
  "admin.settings.session_policy_remember_days_label":
    'Duração do "manter conectado" (dias)',
  "admin.settings.session_policy_remember_days_hint":
    "Duração da sessão OIDC persistente quando o checkbox está marcado.",
  "admin.settings.session_policy_default_hours_label":
    "Duração padrão da sessão (horas)",
  "admin.settings.session_policy_default_hours_hint":
  ...
  "admin.settings.lockout_base_lockout_sec_label":
    "Duração do primeiro bloqueio (segundos)",
  "admin.settings.lockout_max_lockout_sec_label":
    "Duração máxima do bloqueio (segundos)",
  ...
  "admin.settings.rate_limit_login_points_label":
    "Bucket de login: requests permitidos",
  "admin.settings.rate_limit_login_duration_label":
  ...
  "admin.settings.password_policy_from_config":
    "Fonte: config estático / defaults",
  ...
  "admin.settings.notifications_new_login_label":
    "Enviar alerta de novo login (novo IP)",
  "admin.settings.notifications_new_device_label":
    "Enviar alerta de login de novo dispositivo",

  // Admin settings — trusted_devices.
  "admin.settings.trusted_devices_section":
    "Dispositivos confiáveis (pular MFA)",
  "admin.settings.trusted_devices_intro":
  ...
  "admin.settings.account_expiration_section":
  ...
  "mail.account_expiration_warn.subject":
    "Sua conta será desativada por inatividade",
