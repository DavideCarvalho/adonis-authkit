...
export function ClientsListContainer({ onEdit, onDelete, onRegenerate }: ClientsListContainerProps) {
            ...
            <div key={c.clientId} className="panel" style={{ padding: '14px 16px' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 14 }}>
                ...
                <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                  ...
                  <button className="btn btn-sm" onClick={() => onRegenerate(c)} title="Regenerate secret">
